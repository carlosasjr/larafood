...
@section('auth_body')
    ...
    <form action="{{ $register_url }}" method="post">
        ...
        <div class="input-group mb-3">
            ...
            <div class="input-group-append">
                <div class="input-group-text">
                    <span class="fas fa-vcard {{ config('adminlte.classes_auth_icon', '') }}"></span>
                </div>
            </div>
            @if($errors->has('cnpj'))
        ...
        {{-- Tenant field --}}
        <div class="input-group mb-3">
            <input type="text" name="tenant" class="form-control {{ $errors->has('tenant') ? 'is-invalid' : '' }}"
                   value="{{ old('tenant') }}" placeholder="Nome da Empresa">
            <div class="input-group-append">
                <div class="input-group-text">
